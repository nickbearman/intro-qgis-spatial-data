...
output:
  ...
  html_document:
    df_print: paged 
date: "Practicals 1 & 2: Wed 8th June 2022"
---
...
- Start QGIS by clicking on Start, then type **QGIS** and select **QGIS Desktop 3.22.7**. *Your version number might vary, **QGIS Desktop** is the key bit.*  
...
*This practical was written using QGIS 3.22 on Windows 10, last updated on 04/06/2022 by Dr Nick Bearman, [nick@geospatialtrainingsolutions.co.uk](nick@geospatialtrainingsolutions.co.uk). Thanks to Chris Bell for providing the geocoding resource at https://www.doogal.co.uk.*
