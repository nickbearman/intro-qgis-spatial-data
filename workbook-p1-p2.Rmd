...
output:
  ...
  html_document:
    df_print: paged 
date: "Practicals 1 & 2: Tue 7th & Wed 8th March 2023"
---
...
- Start QGIS by clicking on Start, then type **QGIS** and select **QGIS Desktop 3.22.16**. *Your version number might vary, **QGIS Desktop** is the key bit.*  
...
*This practical was written using QGIS 3.22 on Windows 11, last updated on 13/02/2023 by Dr Nick Bearman, [nick@geospatialtrainingsolutions.co.uk](nick@geospatialtrainingsolutions.co.uk). Thanks to Chris Bell for providing the geocoding resource at https://www.doogal.co.uk.*
