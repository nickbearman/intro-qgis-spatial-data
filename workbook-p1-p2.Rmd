...
- In URL paste in `http://mt0.google.com/vt/lyrs=y&hl=en&x={x}&y={y}&z={z}&s=Ga` *(or copy and paste from the PDF)* 
...
*This practical was written using QGIS 3.22 on Windows 10, last updated on 02/03/2022 by Dr Nick Bearman, [nick@geospatialtrainingsolutions.co.uk](nick@geospatialtrainingsolutions.co.uk). Thanks to Chris Bell for providing the geocoding resource at https://www.doogal.co.uk.*
