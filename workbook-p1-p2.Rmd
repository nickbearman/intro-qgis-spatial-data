...
- Open the Google Drive folder and find the `prac1.zip` file.  
...
- Set **Value** to `CTYUA24NM` and choose **OK**.  
...
![](images/highlight-area-example.png)

If you have time, you can update the London map so it just shows the London Boroughs rather than the whole area. The example above is for Utah in the US, and we can apply the same technique to London. 
