...
subtitle: "Tue 4th & Wed 5th August 2026"
author: "Nick Bearman"
format: 
  revealjs:
...
- 2:00pm – 2:45pm: What is GIS and Spatial Data?
- 2:45pm – 3:30pm: Practical 1
- 3:30pm – 3:45pm: break
- 3:45pm – 4:15pm: Classification discussion
- 4:15pm – 5:00pm: Practical 1
...
- 2:00pm – 2:45am: What is GIS and Spatial Data?
- 2:45pm – 3:30pm: Practical 1
- 3:30pm – 3:45pm: break
- 3:45pm – 4:15pm: Classification discussion
- 4:15pm – 5:00pm: Practical 1
...
-   Nearly all human activities & decisions involve geography
    -   the "**where?**"
-   GIS is bit like a spreadsheet, row ~ an geographic area
    -   But it is also so much more than this

## GIS 

-   Working with geographic information is **different** to working with an **Excel** or **CSV** file
-   This is why we need specialized **GIS** software to:
    -   **access** and **relate**
    -   **change** and **visualise** spatial data
...
![](images/classification-exercise-map.png){.absolute bottom="-50" width="1000"}

- Go to [www.colorbrewer2.org](http://www.colorbrewer2.org)
- How many classes would you use to categorise the data?
- What are those classes?
- What colour scheme would you use? Why?
- Please share the ColorBrewer link in the chat
...
- Next session Wed 5th Aug, 2pm (London/UK)
...
- 2:00pm – 2:20pm: Recap and Cartography / Map Design
- 2:20pm – 3:30pm: Practical 2a
- 3:30pm – 3:45pm: break
- 3:45pm – 5:00pm: Practical 2b & Working with your own data
-->
...
-->
- 2:00pm – 2:20pm: Scale and Cartography / Map Design
- 2:20pm – 3:30pm: Practical 2a
- 3:30pm – 3:45pm: break
- 3:45pm – 5:00pm: Practical 2b & Working with your own data
...
- QGIS is an open source project - **Free to use**
- It needs funding
- Opportunity to support QGIS by getting a QGIS Certificate of Completion for this course (€20, £17.75, $23.50)
- Nick Bearman (Geospatial Training Solutions) is a QGIS approved training organisation
- [qgis.org/community/certification/](https://qgis.org/community/certification/)
- Email me [nick@nickbearman.com](mailto:nick@nickbearman.com) if you are interested
...
- More questions welcome on the forum

- Next course:
  - [Advanced QGIS: Spatial Analysis](https://instats.org/seminar/advanced-qgis-spatial-analysis-20)
  - Tue 11th and Wed 12th Aug 2026, 2pm - 5pm (UK/London)
