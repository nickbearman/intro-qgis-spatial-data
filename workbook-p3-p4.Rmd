...
- If you have time, try loading in the Style template that we used before  `prac2-imd-d-style.qml`.  
...
![](images/save-error.png){ width=50% }
...
*This practical was written using QGIS 3.22 on Windows 10, last updated on 02/03/2022 by Dr Nick Bearman, [nick@geospatialtrainingsolutions.co.uk](nick@geospatialtrainingsolutions.co.uk).*
