...
output:
  ...
  html_document:
    ...
    toc_float: TRUE
    self_contained: TRUE
date: 'Practicals 3 & 4: Mon 4th & Tue 5th March 2024'
---
...
- Open the Attribute Table of the **Refactored** layer to check the output. Does the **Pop2018** column have the correct data in it?
...
- Remember to choose the GeoPackage file name and a sutiable name for the layer:
