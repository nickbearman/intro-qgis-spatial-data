...
output:
  ...
  html_document:
    df_print: paged
date: 'Practicals 3 & 4: Tue 13th July 2023'
---
...
- Click the link **OS Open Greenspace - ESRI® Shapefile SU (2.33 MB)** to download.  
...
- Click **Close**.  
- Click **Plugins > DataPlotly > DataPlotly** or click the Plotly icon ![](images/plotly.png){ height=20 }.  
...
- It should give you a preview value for **Arun** of `1.237`.  
- Click **OK**.  
- Save the data.  
...
*This practical was written using QGIS 3.22 on Windows 11, last updated on 04/07/2023 by Dr Nick Bearman, [nick@geospatialtrainingsolutions.co.uk](nick@geospatialtrainingsolutions.co.uk).*
