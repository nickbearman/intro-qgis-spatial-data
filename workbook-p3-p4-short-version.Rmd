...
Now we can move to QGIS and start a new project.  
...
- If the calculation has worked, save this as a new GeoPackage layer.  
...
- It should give you a preview value for **Arun** of `1.25`.  
- Click **OK**.  
- Save the data.  
